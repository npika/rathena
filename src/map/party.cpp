...
int party_skill_check(map_session_data *sd, int party_id, uint16 skill_id, uint16 skill_lv)
{
	...
	switch(skill_id) {
		...
		case MO_COMBOFINISH: //Increase Counter rate of Star Gladiators
			...
			break;
		//case AM_TWILIGHT2: //Twilight Pharmacy, requires Super Novice. but, can solo [Parodius]
		//	return p->state.snovice;
		//case AM_TWILIGHT3: //Twilight Pharmacy, Requires Taekwon. but, can solo [Parodius]
		//	return p->state.tk;
		default:
