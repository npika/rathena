...
#define SKILL_NAME_LENGTH 40 /// Max Skill Name length [Parodius]
#define SKILL_DESC_LENGTH 40 /// Max Skill Desc length [Parodius]

/// Used with tracking the hitcount of Earthquake for skills that can avoid the first attack
#define NPC_EARTHQUAKE_FLAG 0x800

/// To control alternative skill scalings [Parodius]
#define SKILL_ALTDMG_FLAG 0x10
/// Make skill ignore requirement consumption [Parodius]
#define SKILL_NOCONSUME_REQ 0x20
/// Make skill consume ammo, but not the unit [Parodius]
